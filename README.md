...
The project is in Phase 1. The current accepted milestone is the engineering foundation; Rating Engine v0.1 and the batter-versus-pitcher CLI checkpoint are next. Career and Manager modes intentionally have not started.
