...
const stats = { games: 4, pa: 16, hits: 4, home_runs: 1, walks: 2, strikeouts: 3, avg: .286, obp: .375, slg: .571, ops: .946 }
...
const career = {
  ...
  available_actions: ['plan_week'], season_award: null, contract_summary: null,
}
...
test('renders the weekly career dashboard instead of next-PA grinding', async () => {
  ...
  expect(screen.getByText('跑壘代理，暫不影響 PA')).toBeInTheDocument()
